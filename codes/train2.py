...
def main():
    ...
    parser.add_argument('-opt', type=str, default='options/train2.yml', help='Path to option YMAL file.')
        ...
        for _, train_data in enumerate(train_loader):
            ...
            if current_step % opt['logger']['save_checkpoint_freq'] == 0:
                if rank <= 0:
                    ...
                    # resume_model = create_model(opt)
                    # opt['path']['resume_state'] = '../experiments/Corrupted_noise/training_state/10.state'
                    # opt['path']['pretrain_model'] = '../experiments/Corrupted_noise/models/10_G.pth'
                    #
                    # resume_state = torch.load(opt['path']['resume_state'],
